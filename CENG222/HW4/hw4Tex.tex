...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Screenshot 2024-05-28 at 18.49.46.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Screenshot 2024-05-28 at 18.45.31.png}
    \caption{Expected Output of the Code}
    \label{fig:enter-label}
\end{figure}

From our simulation, according to Figure 2, we have found that the probability of the bridge collapsing is 0.405, indicating a significant risk. Additionally, the total weight of all vehicles crossing the bridge was estimated to be approximately 240196. The standard deviation of this total weight was estimated to be approximately 51459. Given that the size of our Monte Carlo simulation was 4148, which is quite large, we can confidently say that our estimate of the standard deviation is highly accurate.\\

To find the new Poisson variable $\lambda_T$ so that the probability of bridge’s collapse is less than 0.1, we can change manually the variable (decrease one by one) and rerun our simulation. \\

Let's decrease our $\lambda_T$ by 1 ($\lambda_T$ = 11):

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{image.png}
    \caption{Simulation result with $\lambda_T$ = 11 }
    \label{fig:enter-label}
\end{figure}

We get approximately 0.31, so keep going until go below 0.1 :

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{image.png}
    \caption{Simulation result with $\lambda_T$ = 10}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{image.png}
    \caption{Simulation result with $\lambda_T$ = 9}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{image.png}
    \caption{Simulation result with $\lambda_T$ = 8}
    \label{fig:enter-label}
\end{figure}

Now we get the probability as 0.06 which is less then 0.1. Thus, we can say that the highest limit for number of trucks is 8.
\end{document}
