...
dec_input:
    ...
    check0:
 btfsc PORTE, 0
 goto re0_pressed ; go if ((PORTB) and 0FFh), 7, a = 1
 btfsc prev_re0, 0
 ...
 re0_pressed:
    ...
    check1:
 btfsc PORTE, 1
 goto re1_pressed ; go if ((PORTB) and 0FFh), 1, a = 1
 btfsc prev_re1, 0
 ...
 re1_pressed:
    ...
    check2:
 btfsc PORTE, 2
 goto re2_pressed ; go if ((PORTB) and 0FFh), 2, a = 1
 btfsc prev_re2, 0
 ...
 re2_pressed:
    ...
    check3:
 btfsc PORTE, 3
 goto re3_pressed ; go if ((PORTB) and 0FFh), 7, a = 1
 btfsc prev_re3, 0
 ...
 re3_pressed:
    ...
    check4:
 btfsc PORTE, 4
 goto re4_pressed ; go if ((PORTB) and 0FFh), 4, a = 1
 btfsc prev_re4, 0
 ...
 re4_pressed:
    ...
    check5:
 btfsc PORTE, 5
 goto re5_pressed ; go if ((PORTB) and 0FFh), 5, a = 1
 btfsc prev_re5, 0
...
check_input:
    btfsc PORTE, 7
    goto re7_pressed ; go if ((PORTB) and 0FFh), 7, a = 1
    btfsc prev_re7, 0
