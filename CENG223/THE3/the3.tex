...
Let's choose 1 element in the codomain, we have \(\binom{3}{1}\) posibilities. Then, we have \(1^5=1\) functions from a set with five elements to the remaining one element in the each codomain. 
Since first condition (\(\binom{3}{2}2^5\)) counts this condition two times, we should add it up to the our result.\\
\[
\binom{3}{1}
\]
